...
- Show only Makefile comments as descriptions in --make mode
- Merge pull request #22 from cesarferreira/fix-make-picker-descriptions
## [1.4.0] - 2026-07-29

### Changed

- Add robin --make to read tasks from a Makefile
## [1.3.0] - 2026-07-03

### Changed

- Add release workflow that publishes GitHub Releases on tag push
## [1.2.0] - 2026-07-01
